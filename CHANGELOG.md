...
## [Unreleased]
### Fixed
- documentation for Doctrine mappings.
...
## [10.0.0] - 2024-09-10
### Added
- `NullableDescription` trait.

### Changed
- the `Description` trait is not longer nullable, use the new `NullableDescription` trait to keep the behaviour.
...
## [8.1.0] - 2024-06-19
### Added
- `AbstractIntId` and `IntIdInterface`.

## [8.0.0] - 2024-06-14
### Changed
- `IntId` is now a trait and not an abstract class.
- Minimum requirement Doctrine ORM 3.2.

## [7.1.2] - 2024-02-20
### Fixed
- Type for \DateTimeImmutable fields in annotations.

## [7.1.1] - 2024-02-20
### Fixed
- Type for \DateTimeImmutable fields.
